...
https://github.com/homelab-alpha/dotfiles/blob/main/CONTRIBUTING.md#pull-requests

How to Respond to Questions in This Pull Request

1. Carefully read each question in the pull request dotfiles.
...
4. Do not remove the HTML comment tags, as this will break the Pull Request dotfiles.
...
- [ ] 🔍 My code follows the [style guidelines](https://github.com/homelab-alpha/dotfiles/blob/main/CODE_STYLE_AND_STANDARDS_GUIDES.md) of this project.
...
- [ ] 📚 I have read and understood the [Pull Request Guidelines](https://github.com/homelab-alpha/dotfiles/blob/main/CONTRIBUTING.md#pull-requests).
- [ ] ✍️ I have completed the [Author Self-Review Process](https://github.com/homelab-alpha/dotfiles/blob/main/.github/review_process_template.md).
